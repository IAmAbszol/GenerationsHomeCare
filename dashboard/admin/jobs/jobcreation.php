		...
		<script type="text/javascript">
			function validateInput() {
				...
				if(document.getElementById('amountdue').value == "") {
					document.getElementById('amountdue').style.border = "2px solid #fc677d";
					$( document ).ready(function() {
						toastr.error('Amount due must contain a value, even if its 0.00.', 'Error!');
					});
					noerrors = false;
				} else {
					document.getElementById('amountdue').style.border = "0";
					document.getElementById('amountdue').style.borderBottom = "1px solid black";
				}
				return noerrors;
			}
			...
			function switchWeek() {
				...
				if(week == 0) {
					...
					// second week
					document.getElementById('startOfWeek').innerHTML = "<?php echo "$days[7]"; ?>";
					document.getElementById('mondayDate').value = "<?php echo "$days[7]"; ?>";
					document.getElementById('tuesdayDate').value = "<?php echo "$days[8]"; ?>";
					document.getElementById('wednesdayDate').value = "<?php echo "$days[9]"; ?>";
					document.getElementById('thursdayDate').value = "<?php echo "$days[10]"; ?>";
					document.getElementById('fridayDate').value = "<?php echo "$days[11]"; ?>";
					document.getElementById('saturdayDate').value = "<?php echo "$days[12]"; ?>";
					document.getElementById('sundayDate').value = "<?php echo "$days[13]"; ?>";
					document.getElementById('endOfWeek').innerHTML = "<?php echo "$days[13]"; ?>";
				}
			}
		</script>
    <style>
			          ...
			          <div class="table-responsive">
			            <table class="table borderless" id="dataTable" width="100%" cellspacing="0">
					          <tbody>
											<tr>
												<th>
													Select Week <select onchange="switchWeek()" id="weekSelect"><option value="0">This Week</option><option value="1">Next Week</option></select>
												</th>
											</tr>
											<tr>
												<th>
